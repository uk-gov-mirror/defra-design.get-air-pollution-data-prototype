...
(function () {
  const CONTAINER_ID = "pm25-container-month";
  const CSV_PATH = "/public/javascripts/version_13/chart-data/past-month/pm2_5.csv";
  ...
  if (!window.__AQ_PM25_MONTH_LISTENERS__) {
    window.__AQ_PM25_MONTH_LISTENERS__ = true;
  ...
  function drawChart() {
    ...
    d3.csv(CSV_PATH).then(function (raw) {
      ...
      if (!window.__AQ_PM25_MONTH_CLEAR_CLICK__) {
        window.__AQ_PM25_MONTH_CLEAR_CLICK__ = true;
  ...
  window.AQGraphs.pm25_month = drawChart;
