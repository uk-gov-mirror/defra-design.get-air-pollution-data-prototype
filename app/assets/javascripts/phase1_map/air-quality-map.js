...
const mockStations = [
  ...
  { id: 1004, name: "London Bexley", lat: 51.456, lng: 0.148, authority: "London Borough of Bexley", pollutants: ["NO2","PM10","O3","PM2.5"], status: "inactive", inactiveReason: "an instrument fault", daqi: 1, siteType: "Urban background", startDate: "1997-06-01" },
  ...
  { id: 2007, name: "Chatham Roadside", lat: 51.380, lng: 0.540, authority: "Medway Council", pollutants: ["NO2","PM10","PM2.5"], status: "inactive", inactiveReason: "a communication failure", daqi: 2, siteType: "Urban traffic", startDate: "2000-01-01" },
  ...
  { id: 3002, name: "Cambridge Roadside", lat: 52.205, lng: 0.119, authority: "Cambridge City Council", pollutants: ["NO2","PM10"], status: "inactive", inactiveReason: "an instrument fault", daqi: 2, siteType: "Urban traffic", startDate: "2000-01-01" },
  ...
  { id: 3019, name: "Nottingham Western Boulevard", lat: 52.954, lng: -1.136, authority: "Nottingham City Council", pollutants: ["NO2","PM10","PM2.5"], status: "inactive", inactiveReason: "a communication failure", daqi: 2, siteType: "Urban traffic", startDate: "2008-01-01" },
  ...
  { id: 4006, name: "Coventry Binley Road", lat: 52.389, lng: -1.495, authority: "Coventry City Council", pollutants: ["NO2","PM10","PM2.5"], status: "inactive", inactiveReason: "an instrument fault", daqi: 2, siteType: "Urban traffic", startDate: "2008-01-01" },
  ...
  { id: 5003, name: "Bristol Temple Way", lat: 51.458, lng: -2.598, authority: "Bristol City Council", pollutants: ["NO2","PM10","PM2.5"], status: "inactive", inactiveReason: "a communication failure", daqi: 2, siteType: "Urban traffic", startDate: "2008-01-01" },
  ...
  { id: 6003, name: "Swansea Roadside", lat: 51.621, lng: -3.943, authority: "Swansea Council", pollutants: ["NO2","PM10","PM2.5"], status: "inactive", inactiveReason: "an instrument fault", daqi: 2, siteType: "Urban traffic", startDate: "2005-01-01" },
  ...
  { id: 7004, name: "Sheffield Barnsley Road", lat: 53.369, lng: -1.430, authority: "Sheffield City Council", pollutants: ["NO2","PM10"], status: "inactive", inactiveReason: "a communication failure", daqi: 2, siteType: "Urban traffic", startDate: "2008-01-01" },
  ...
  { id: 8002, name: "Manchester Sharston", lat: 53.361, lng: -2.250, authority: "Manchester City Council", pollutants: ["NO2","PM10","PM2.5","O3"], status: "inactive", inactiveReason: "an instrument fault", daqi: 2, siteType: "Suburban", startDate: "2003-01-01" },
  ...
  { id: 10002, name: "Glasgow High Street", lat: 55.861, lng: -4.256, authority: "Glasgow City Council", pollutants: ["NO2","PM10","PM2.5"], status: "inactive", inactiveReason: "a communication failure", daqi: 2, siteType: "Urban traffic", startDate: "2008-01-01" },
...
// Map feature: show/hide closed + inactive stations (inactive shown by default, closed hidden)
...
function stationMatches(station, state) {
  ...
  // Hide closed stations unless the toggle is on; inactive always shown
  if (!showClosedAndInactiveStations && station.status === 'closed') {
    return false;
  }
...
function updateMarkerAppearance(station, entry) {
  ...
  if (colourByDaqi && station.status === 'active') {
...
function clearSelectedMarker() {
  ...
  <dl class="govuk-body-s station-info-list">
    ${station.status && station.status.toLowerCase() === 'inactive' && station.inactiveReason ? `
      <div class="station-info-row">
        <dd class="govuk-hint govuk-!-margin-bottom-1">Inactive due to ${station.inactiveReason}</dd>
      </div>` : ''}
  ...
  <p class="govuk-!-margin-bottom-3 govuk-!-margin-top-3"><a href="/phase1-map/station/station.html" class="govuk-link">View station summary</a></p>
`;
...
function renderDataSources(root, mount, uiId) {
  ...
  // Add network radio groups content — restrict to AURN only
  const networksDiv = document.createElement('div');
  networksDiv.innerHTML = renderNetworkRadioGroupsHtml(uiId, availableNetworks.filter(n => n === NETWORK.AURN));
